...
// 利用者が編集したファイルは上書きせず、隣に .new を置いて報告する(決定 2026-09-04 → manual/init-update.md「決めたこと」)。
//
// hub は台帳の Features に記録された機能の分だけ追従する(足していない機能のファイルは作らない・決定 2026-09-05 → manual/init-update.md「決めたこと」)。
...
// 決定 2026-09-05 → manual/init-update.md「決めたこと」)。揃っていれば「そのまま」に数え、台帳は据え置く(利用者の版のハッシュを記録すると、次回「配った版のまま」と

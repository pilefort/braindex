...
// 編集したかを見分ける(決定 2026-09-04 → manual/init-update.md「決めたこと」)。dpkg が conffile の MD5 を記録するのと同じ型で、
...
// Features は init -add で足した機能(core を除く・名前の昇順)。update はこの分だけ追従する(決定 2026-09-05 → manual/init-update.md「決めたこと」)。
